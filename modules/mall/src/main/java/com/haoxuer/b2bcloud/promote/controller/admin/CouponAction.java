...
import com.haoxuer.b2bcloud.promote.data.so.CouponSo;
...
public class CouponAction extends TenantBaseAction {
	...
	public static final String REDIRECT_LIST_HTML = "redirect:/tenant/coupon/view_list.htm";

	private static final Logger log = LoggerFactory.getLogger(CouponAction.class);

	@Autowired
	private CouponService manager;
	...
	public String list(Pageable pageable,CouponSo so,ModelMap model) {
		...
		Page<Coupon> pagination = manager.page(pageable);
	...
	@RequiresPermissions("coupon")
	@RequestMapping("/tenant/coupon/view_add")
	public String add(ModelMap model) {
		return  getView("coupon/add");
	}

	@RequiresPermissions("coupon")
	@RequestMapping("/tenant/coupon/view_edit")
	public String edit(Pageable pageable,Long id, ModelMap model) {
		Tenant tenant=tenantService.cur();
		model.addAttribute(MODEL, manager.findById(tenant.getId(),id));
		model.addAttribute("page", pageable);
		return getView("coupon/edit");
	}

	@RequiresPermissions("coupon")
	@RequestMapping("/tenant/coupon/view_view")
	public String view(Long id,ModelMap model) {
		Tenant tenant=tenantService.cur();
		model.addAttribute(MODEL, manager.findById(tenant.getId(),id));
		return getView("coupon/view");
	}

	@RequiresPermissions("coupon")
	@RequestMapping("/tenant/coupon/model_save")
	public String save(Coupon bean,ModelMap model) {
		...
		try {
			...
			view=getView("coupon/add");
		}
		return view;
	}

	@RequiresPermissions("coupon")
	@RequestMapping("/tenant/coupon/model_update")
	public String update(Pageable pageable, Coupon bean, RedirectAttributes redirectAttributes, ModelMap model) {
		...
		try {
		    ...
		    model.addAttribute("page", pageable);
			view=getView("coupon/edit");
		}
		return view;
	}
	@RequiresPermissions("coupon")
	@RequestMapping("/tenant/coupon/model_delete")
	...
	@RequiresPermissions("coupon")
	@RequestMapping("/tenant/coupon/model_deletes")
