package com.haoxuer.b2bcloud.mall.data.common;
...
/**
 *  * 编码码生成器，生成32位数字编码，  * @生成规则 1位单号类型+17位时间戳+14位(用户id加密&随机数)  *
 *
 */
public class CodeFactory {
	/** 商品类别头 */
	private static final String GOOD_CODE = "100";
	/** 订单类别头 */
	 ...
	 * @return
	 */
	public static String getGoodCode(Long goodsId) {
		return GOOD_CODE + getCode(goodsId);
	}
